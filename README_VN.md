...
[![CI](https://github.com/manhquydev/mq_flow/actions/workflows/ci.yml/badge.svg)](https://github.com/manhquydev/mq_flow/actions/workflows/ci.yml) — 16 bộ test / 291 check trên macOS · Ubuntu · Windows
...
├── tests/run_all.sh             # 16 bộ test / 291 check
...
> trên Windows/Git Bash; bộ test dev là 16 bộ / 291 check (`bash tests/run_all.sh`).
...
## Chạy test
```bash
bash tests/run_all.sh    # 16 bộ test / 291 check; cần bash (+ python cho bộ harness/propose)
```
