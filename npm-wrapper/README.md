...
| **Current GA** | **0.7.1** — ships skill product **v0.31.0** |
...
| Pin installer `@0.7.1` if needed | Pin npm `@0.31.0` (skill version ≠ package version) |
...
| `No matching version found` for `@0.31.0` | That is the **skill** version. Use `@latest` or `@0.7.x` |
