...
for suite in test_flow_runner.sh test_flow_harness.sh test_flow_scenarios.sh test_flow_project_types.sh test_flow_gate_wording.sh test_flow_coverage_gaps.sh test_flow_concurrency_lock.sh test_flow_recall.sh test_flow_accessed_count.sh test_flow_gate_capture.sh test_flow_propose_audit.sh test_flow_contract.sh test_flow_tokens.sh test_flow_coherence_kb.sh test_flow_assess.sh test_flow_codex_integration.sh test_flow_consistency.sh test_flow_constitution.sh test_flow_open_decisions.sh test_flow_slice_quality.sh test_flow_converge.sh test_flow_antigravity_integration.sh test_flow_claudekit_integration.sh test_flow_card_lifecycle.sh test_flow_done_evidence.sh test_flow_auto_done_path.sh test_flow_usage_log.sh test_flow_workspace.sh test_flow_monorepo_root.sh test_flow_harness_args.sh test_flow_schema_migration.sh test_flow_tool_registry.sh test_flow_loop.sh test_flow_eval.sh test_flow_resume.sh test_flow_status_legibility.sh test_flow_concierge.sh test_flow_native_rituals.sh test_flow_forge_idea.sh test_flow_harness_lineage_contract.sh test_flow_graph_schema.sh test_flow_graph_executor.sh test_flow_graph_crash_resume.sh test_flow_graph_lint.sh test_flow_graph_auto_run.sh test_flow_graph_parallel_cards.sh test_flow_graph_planning_parity.sh test_flow_harness_strict.sh test_flow_harness_trust_complete.sh test_flow_skill_harness_docs_contract.sh test_flow_attestation_contract.sh test_flow_card_risk.sh test_flow_attestation_supervisor.sh test_flow_attestations.sh test_flow_auto_attestation_enforcement.sh test_flow_attestation_harden.sh test_release_coherence.sh test_harness_cli_optional_smoke.sh; do
  echo "==================== $suite ===================="
