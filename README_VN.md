...
[![CI](https://github.com/manhquydev/mq_flow/actions/workflows/ci.yml/badge.svg)](https://github.com/manhquydev/mq_flow/actions/workflows/ci.yml) — 15 bộ test / 243 check trên macOS · Ubuntu · Windows
...
> Trạng thái: **v0.4** — engine + **vòng tri thức** bền vững khép kín (recall · audit/propose · KB
...
├── tests/run_all.sh             # 15 bộ test / 243 check
...
> trên Windows/Git Bash; bộ test dev là 15 bộ / 243 check (`bash tests/run_all.sh`).
...
## Chạy test
```bash
bash tests/run_all.sh    # 15 bộ test / 243 check; cần bash (+ python cho bộ harness/propose)
```
