...
GATE00="$SKILL_DIR/references/gate-00.md"
GATE02="$SKILL_DIR/references/gate-02.md"
...
echo "D) gate-00.md / gate-02.md offer it at Idea (00) and Scope (02), opt-in-with-prompt"
gr="$(cat "$GATE00" "$GATE02" 2>/dev/null)"
stage00_block="$(cat "$GATE00" 2>/dev/null)"
stage02_block="$(cat "$GATE02" 2>/dev/null)"
