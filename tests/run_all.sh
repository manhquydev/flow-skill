...
rc=0
for suite in test_flow_runner.sh test_flow_harness.sh test_flow_scenarios.sh test_flow_project_types.sh test_flow_gate_wording.sh test_flow_coverage_gaps.sh test_flow_concurrency_lock.sh test_flow_recall.sh test_flow_gate_capture.sh test_flow_propose_audit.sh test_flow_contract.sh test_flow_tokens.sh test_flow_coherence_kb.sh; do
  echo "==================== $suite ===================="
