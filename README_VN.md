...
[![CI](https://github.com/manhquydev/mq_flow/actions/workflows/ci.yml/badge.svg)](https://github.com/manhquydev/mq_flow/actions/workflows/ci.yml) — 23 bộ test / 538 check trên macOS · Ubuntu · Windows
...
> Trạng thái: **v0.13.1** — gia cố từ việc soi chính telemetry của flow trên 2 dự án thật: CLI **`harness`**
...
> **23 bộ test / 538 check xanh** trên macOS · Ubuntu · Windows. MIT.
...
├── tests/run_all.sh             # 23 bộ test / 538 check
...
> trên Windows/Git Bash; bộ test dev là 23 bộ / 538 check (`bash tests/run_all.sh`).
...
## Chạy test
```bash
bash tests/run_all.sh    # 23 bộ test / 538 check; cần bash (+ python cho bộ harness/propose)
```
