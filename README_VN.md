...
| **npm installer** | [`@manhquy/flow-skill`](https://www.npmjs.com/package/@manhquy/flow-skill) **0.7.x** (`@latest` 0.7.2 ship skill ở trên) |
...
Đừng pin `@0.32.0` trên npm — đó là version skill, không phải installer.
