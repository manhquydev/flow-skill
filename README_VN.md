...
├── tests/run_all.sh             # 27 bộ test / 633 check
...
> trên Windows/Git Bash; bộ test dev là 27 bộ / 633 check (`bash tests/run_all.sh`).
...
## Chạy test
```bash
bash tests/run_all.sh    # 27 bộ test / 633 check; cần bash (+ python cho bộ harness/propose)
```
