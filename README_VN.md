...
library, một lần chạy thật cho skill Claude Code. Bổ sung **lớp harness bền vững** (intake /
story / trace / decision / backlog), điều phối agent đa nhà cung cấp (Claude + Codex GPT-5.x +
Antigravity Gemini-3 → gate đối kháng ba mô hình), và nhận biết loại dự án.
