...
| **Current GA** | **0.7.2** — ships skill product **v0.32.0** |
...
| Pin installer `@0.7.2` if needed | Pin npm `@0.32.0` (skill version ≠ package version) |
...
| `No matching version found` for `@0.32.0` | That is the **skill** version. Use `@latest` or `@0.7.x` |
